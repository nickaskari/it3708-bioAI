...
var train_file string = "train/test_1.json"

// Benchmark stop criteria. 0 essentially deactivates this.
var benchmark float64 = 1296.75
...
var islandConfigs = []struct {
	...
	{numParents, populationSize, 0.9, 0.2, gmax, 500, 0.1, 0.05, 1},
	{numParents, populationSize, 0.9, 0.2, gmax, 1000, 0.1, 0.05, 1},
	{numParents, populationSize, 0.9, 0.2, gmax, 1000, 0.1, 0.05, 1},
	{numParents, populationSize, 0.8, 0.4, gmax, 1000, 0.1, 0.05, 1},
...
func main() {
	...
	fmt.Println("\nThe Genetic Algorithm took", duration.Seconds(), "seconds to run.")
}
